 ...
 * The 'FinalFour' class has been created to make a certain level in the game named 'Final Four'.
 */
public class FinalFour implements LevelInformation {
    ...
    private static final double MIDDLE_BALL_X_POSITION = 400;
    private static final double MIDDLE_BALL_Y_POSITION = 350;
    private static final double RIGHT_BALL_X_POSITION = 500;
    private static final double RIGHT_BALL_Y_POSITION = 400;
    private static final int NUMBER_OF_BLOCKS = 105;
    private static final double LEFT_BALL_Y_COMPONENT_VELOCITY = -6;
    private static final double LEFT_BALL_X_COMPONENT_VELOCITY = -4;
    private static final double MIDDLE_BALL_Y_COMPONENT_VELOCITY = -6;
    private static final double MIDDLE_BALL_X_COMPONENT_VELOCITY = 0;
    ...
    private static final int BLOCK_ROWS = 7;
    private static final int BLOCK_COLUMNS = 15;
    ...
    public FinalFour() {
        ...
        this.balls.add(new Ball(new Point(MIDDLE_BALL_X_POSITION, MIDDLE_BALL_Y_POSITION), BALL_RADIUS, Color.BLACK));
        ...
        velocities.add(new Velocity(MIDDLE_BALL_X_COMPONENT_VELOCITY, MIDDLE_BALL_Y_COMPONENT_VELOCITY));
    ...
    public List<Block> blocks() {
        ...
        Color[] colorArr = {Color.GRAY, Color.RED, Color.YELLOW, Color.GREEN, Color.BLUE, Color.PINK,
                Color.CYAN};
